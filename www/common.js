...
let UserServiceService = class UserServiceService {
    constructor(http, router) {
        this.http = http;
        this.router = router;
        this.startGameInfo = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject({});
        this.staticSelfInfo = { 'userId': 0, 'userCode': 0, 'coords': [], 'desc': "" };
        this.staticOtherInfo = { 'userId': 0, 'userCode': 0, 'coords': [], 'desc': "" };
        this.userInfo = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject({ 'userId': 0, 'userCode': 0, 'coords': [], 'desc': "" });
        this.otherUserInfo = new rxjs__WEBPACK_IMPORTED_MODULE_0__.BehaviorSubject({ 'userId': 0, 'userCode': 0, 'coords': [], 'desc': '' });
    }
...
UserServiceService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
/* harmony export */ });
/* harmony import */ var _home_ivan_HACKUPC2022_Join_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_home_ivan_HACKUPC2022_Join_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_home_ivan_HACKUPC2022_Join_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_home_ivan_HACKUPC2022_Join_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,_home_ivan_HACKUPC2022_Join_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
